...
export function ReasoningBasic() {
  const reasoningText = `I've analyzed your customer support data. Based on ticket patterns, I can automate 73% of incoming queries using a custom AI agent. This would reduce response time from 4 hours to under 2 minutes and free your team for complex cases.`;
    ...
    >
      ...
      >
        <div className="flex items-end justify-end gap-3">
          ...
          >
            <p className="text-sm">
              We&apos;re drowning in customer support tickets. Can you help us
