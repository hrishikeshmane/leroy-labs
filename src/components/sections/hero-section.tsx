    ...
    <section id="hero" className="w-full relative">
      <div className="relative flex flex-col items-center w-full px-6">
        <div className="absolute inset-0">
          <div className="absolute inset-0 -z-10 h-[600px] md:h-[560px] w-full [background:radial-gradient(125%_125%_at_50%_10%,var(--background)_40%,var(--secondary)_100%)] rounded-b-xl"></div>
        </div>
        <div className="relative z-10 pt-32 pb-32 md:pb-40 max-w-3xl mx-auto h-full w-full flex flex-col gap-10 items-center justify-center">
          ...
          <div className="flex items-center gap-2.5 flex-wrap justify-center">
            <Link
              ...
              {...(hero.cta.primary.href.startsWith("http")
            ...
            {hero.cta.secondary && (
              <Link
                ...
                {...(hero.cta.secondary.href.startsWith("http")
                  ? { target: "_blank", rel: "noopener noreferrer" }
                  : {})}
