...
export const siteConfig = {
  name: "Leroy Labs",
  description: "AI-native software engineering and forward-deployed automation teams.",
  cta: "Book a Call",
  ...
  nav: {
    links: [
      ...
      { id: 3, name: "How We Work", href: "#features" },
  ...
  footerLinks: [
    {
      title: "Services",
      links: [
        { id: 1, title: "AI Products", url: "#bento" },
        { id: 2, title: "Custom Agents", url: "#bento" },
        { id: 3, title: "Process Automation", url: "#bento" },
        { id: 4, title: "Consulting", url: "#pricing" },
      ],
    },
    {
      title: "Company",
    ...
    },
    {
      title: "Resources",
      links: [
        { id: 9, title: "Case Studies", url: "#" },
        { id: 10, title: "Documentation", url: "#" },
        { id: 11, title: "Privacy Policy", url: "#" },
        { id: 12, title: "Terms of Service", url: "#" },
      ],
    },
  ],
};
